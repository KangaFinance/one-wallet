...
// Obtain the list of pairs and underlying tokens from Kanga deployed on Harmony
// truffle execute scripts/kanga.js --network=harmony-mainnet
module.exports = (callback) => {
  const f = async () => {
    console.log(`factory`)
    const factory = new web3.eth.Contract(IUniswapV2Factory, ONEConstants.Kanga.FACTORY)
    ...
    const outPath = process.env.OUT_PATH || './data/kanga.json'
